...
Collection.prototype.count = function count (query, options, callback) {
  if ('function' === typeof query) callback = query, query = {}, options = {};
  ...
  var read = (typeof this.slaveOk !== 'undefined') ? this.slaveOk : this.db.slaveOk;
  if (typeof options.slaveOk === 'boolean') read = options.slaveOk;
  if (read) {
  ...
  var self = this;
  this.db._executeQueryCommand(queryCommand, {'read': read}, function (err, result) {
