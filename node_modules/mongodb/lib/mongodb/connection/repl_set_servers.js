...
var ReplSetServers = exports.ReplSetServers = function(servers, options) {
  ...
  if(this.strategy != null && (this.strategy != 'ping' && this.strategy != 'statistical' && this.strategy != 'random')) throw new Error("Only ping, statistical or random strategies allowed");
